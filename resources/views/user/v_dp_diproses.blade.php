...
<!-- shop -->
	<div class="container-fluid p-5 mb-5 toko">
		...
		<h5 class="title-content mb-4">Pesananan Di proses</h5>
		<div class="row">
			<!-- kategori kiri -->
                    ...
                    <div class="card mb-2 mt-2">
                        ...
                        <div class="row mb-3 ">
                                <div class="col-md-9">
                                    ...
                                    <button type="button" class="btn btn-warning disabled">Pesanan di proses</button>
                                </div>
                        ...
                        <div class="text-end">
                            <a href="/pemesanan-user/daftar-pesanan-diproses/{{ $item->id_pemesanan }}" class="btn btn-outline-primary"  style="color: blue" >Lihat detail</a>
                        </div>
                        </div>
                    </div>
                @endforeach
