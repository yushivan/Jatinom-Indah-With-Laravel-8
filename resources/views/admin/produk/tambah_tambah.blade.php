  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Menambahkan Harga Produk</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <form method="POST" action="/admin/produk/{{ $harga->id_produk }}/harga" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" disabled  class="form-control" placeholder="{{ $harga->nama_produk }}">
                        </div>
                        <div class="form-group">
                            <label for="harga">Masukkan Harga Produk</label>
                            <input type="number" class="form-control" value="{{ old('harga') }}" id="harga" class="@error('harga') is-invalid @enderror" name="harga" placeholder="Masukkan Harga Produk">
