        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin/pesanan-selesai/">Home</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="modal-footer justify-content-between">
                <a class="btn btn-light" href="/admin/pesanan-selesai/" role="button"></a>
                <a class="btn btn-outline-danger" href="/admin/pesanan-selesai/" role="button">Kembali</a>
            </div>
            </div>
