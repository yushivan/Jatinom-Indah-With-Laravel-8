              ...
              <div class="card">
                <div class="card-header">
                    <div class="card-tools">
                        <form action="/admin/pesanan-diproses/pencarian/cari" method="GET">
                    ...
                    <?php $i=1 ?>
                      @foreach ($pesanan as $item)
                        <tr>
                            ...
                            <td align="center">
                                <a href="/admin/pesanan-diproses/detail-pesanan/{{ $item->id_pemesanan }}" class="btn btn-sm btn-outline-primary"  style="color: blue" >Detail Pemesanan</a>
  ...
  @foreach ($pesanan as $item)
    <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="hapus{{ $item->id_pemesanan }}">
        ...
        <div class="modal-content bg-danger">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a class="btn btn-light" href="/admin/pesanan-diproses/{{ $item->id_pemesanan }}" role="button">Hapus</a>
            </div>
        </div>
        <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" id="verifikasi{{ $item->id_pemesanan }}">
        ...
        <div class="modal-content bg-success">
            <div class="modal-body">
            <p>Pesanan dari <span style="font-weight: bold">{{ $item->nama }}</span>, selesai diproses ?</p>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">Tidak</button>
                <a class="btn btn-light" href="/admin/pesanan-diproses/{{ $item->id_pemesanan }}/verifikasi" role="button">Verifikasi</a>
            </div>
        </div>
        <!-- /.modal-content -->
        </div>
